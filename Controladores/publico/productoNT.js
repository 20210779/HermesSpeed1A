...
// el nombre es por el producto en categorias, la N es de la categoria de niño y la T de su subcategoria de tenis
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaNTenis');
