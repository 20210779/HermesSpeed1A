...
// el nombre es por el producto en categorias, la N es de la categoria de niño y la F de su subcategoria de futbol
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaNFutbol');
