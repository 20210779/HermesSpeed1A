...
// el nombre es por el producto en categorias, la N es de la categoria de niño y la V de su subcategoria de Voleibol
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaNVoleibol');
