...
// el nombre es por el producto en categorias, la M es de la categoria de mujer y la V de su subcategoria de Voleibol
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaMVoleibol');
