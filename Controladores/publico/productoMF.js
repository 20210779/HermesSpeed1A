...
// el nombre es por el producto en categorias, la M es de la categoria de mujer y la F de su subcategoria de futbol
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaMFutbol');
