...
// el nombre es por el producto en categorias, la M es de la categoria de mujer y la T de su subcategoria de tenis
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaMTenis');
