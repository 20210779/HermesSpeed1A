// el nombre es por el producto en categorias, la N es de la categoria de niño y la Be de su subcategoria de baseball
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaNBeisbol');
