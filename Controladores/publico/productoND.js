...
// el nombre es por el producto en categorias, la N es de la categoria de niño y la D de su subcategoria de Calsado Deportivo
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaNDeportivos');
