...
// el nombre es por el producto en categorias, la N es de la categoria de niño y la Ba de su subcategoria de basquetboll
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DATA = await fetchData(PRODUCTO_API, 'readProductosCategoriaNBasquetboll');
