...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    CORRREO_CLIENTE = document.getElementById('correoCliente'),
    TELEFONO_CLIENTE = document.getElementById('telefonoCliente'),
    DUI_CLIENTE = document.getElementById('duiCliente'),
    ESTADO_PRODUCTO = document.getElementById('estadoCliente');
...
const fillTable = async (form = null) => {
    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            ...
            icon = (row.estado_cliente == 1) ? 'bi bi-eye-fill' : 'bi bi-eye-slash-fill';
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        ...
        CORRREO_CLIENTE.value = ROW.correo_cliente;
        CONTRASEÑA_CLIENTE.value = ROW.contraseña_cliente;
...
const openReport = () => {
    ...
    const PATH = new URL(`${SERVER_URL}reportes/privado/cliente.php`);
