        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    ...
                    !$cliente->setDireccion($_FILES['direccionCliente']) or
                    !$cliente->setClave($_FILES['claveCliente']) or
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$cliente->setEstado(isset($_POST['estadoProducto']) ? 1 : 0)
                ) {
                    $result['error'] = $cliente->getDataError();
            ...
            case 'deleteRow':
                if (
                    !$producto->setId($_POST['idCliente'])
                ) {
                    $result['error'] = $cliente->getDataError();
